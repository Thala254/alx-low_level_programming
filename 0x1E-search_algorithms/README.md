...
## Resources
- [Search algorithm](https://www.geeksforgeeks.org/searching-algorithms/?ref=shm)
...
## More
Use the following format for big O notations
- `O(1)`
- `O(n)`
- `O(n!)`
- n*m -> `O(nm)`
...
Write a function that searches for a value in an array of integers using the [Linear search algorithm](https://www.geeksforgeeks.org/linear-search/?ref=lbp)
...
Write a function that searches for a value in a sorted array of integers using the [Binary search algorithm](https://www.geeksforgeeks.org/binary-search/?ref=lbp)
...
Write a function that searches for a value in a sorted array of integers using the [Jump search algorithm](https://www.geeksforgeeks.org/jump-search/?ref=lbp)
...
**Solution [100-jump.c](100-jump.c)**
...
Write a function that searches for a value in a sorted array of integers using the [Interpolation search algorithm](https://www.geeksforgeeks.org/interpolation-search/?ref=lbp)
...
**Solution [102-interpolation.c](103-exponential.c)**
  
### 10. Exponential search

Write a function that searches for a value in a sorted array of integers using the [Exponential search algorithm](https://www.geeksforgeeks.org/exponential-search/?ref=lbp)
...
**Solution [103-exponential.c](103-exponential.c)**
...
**Solution [104-advanced_binary.c](104-advanced_binary.c)**
...
**Solution [105-jump_list.c](105-jump_list.c)**
...
**Solution [106-linear_skip.c](106-linear_skip.c)**
